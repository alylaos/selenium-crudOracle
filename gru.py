...
download_directory = "C:\\bot_sucamec\sucamecpdf"
...
# Ejecuta la consulta
cursor1.execute("""
WITH TrabajadoresEnumerados AS (
    SELECT
        T.NUMERO_DOCUMENTO, 
        T.MATRICULA,
        ROW_NUMBER() OVER (ORDER BY T.NUMERO_DOCUMENTO) AS fila_numero
    FROM 
...
SELECT 
    ...
    MATRICULA
FROM 
    TrabajadoresEnumerados
WHERE 
    MOD(fila_numero, 10) = 0
...
for row in oracle_results:
    ...
    if(step==1):
        ...
        try:
            ...
            if num_carnet and fec_emis_carnet:
                ...
                try:
                    ...
                    print(f"Error al insertar datos de Carné: {e}")
